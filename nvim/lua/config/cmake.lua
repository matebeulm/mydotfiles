...
function M.setup()
	...
	require("cmake").setup({
		...
		configure_args = { "-D", "CMAKE_EXPORT_COMPILE_COMMANDS=1", "-GNinja" }, -- Default arguments that will be always passed at cmake configure step. By default tells cmake to generate `compile_commands.json`.
